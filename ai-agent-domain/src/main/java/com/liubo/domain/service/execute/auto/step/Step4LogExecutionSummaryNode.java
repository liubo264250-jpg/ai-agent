...
import com.liubo.domain.model.valobj.constant.AiClientTypeEnum;
...
import static com.liubo.domain.model.valobj.constant.Constant.CHAT_MEMORY_CONVERSATION_ID_KEY;
import static com.liubo.domain.model.valobj.constant.Constant.CHAT_MEMORY_RETRIEVE_SIZE_KEY;
...
public class Step4LogExecutionSummaryNode extends AbstractExecuteSupport {
    ...
    private void generateFinalReport(ExecuteCommandEntity requestParameter, DefaultAutoAgentExecuteStrategyFactory.DynamicContext dynamicContext) {
        try {
            ...
            AiAgentFlowConfigVO aiAgentClientFlowConfigVO = dynamicContext.getAiAgentClientFlowConfigVOMap().get(AiClientTypeEnum.RESPONSE_ASSISTANT.getCode());
